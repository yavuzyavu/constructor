...
public class Fp03 {
    public static void main(String[] args) {
        ...
        System.out.println();
        sonKariktereGoreTekrarsizYazdir(liste);
        System.out.println();
        uzunlukVeIlkHarfeGoreSiralaYazdir(liste);
        System.out.println();
        //bestenBuyukleriSil(liste);
//        baslangiciAYadaNOlaniSil(liste);
//        baslangiciAYadaNOlaniSil1(liste);
        //uzunlugu8ile10ArasiOlanveyaOİleBiteniSil(liste);
    ...
    public static void sonKariktereGoreTekrarsizYazdir(List<String>list){
    ...
    //6) Uzunluğu 5'ten büyük olan elemanları silen bir method oluşturun.      ==> list mutable oldugu icin elemanlari kalici degismesin diye yoruma aldik
...
//    }
//    //2.Yol:
 //  public static void baslangiciAYadaNOlaniSil1(List<String> list){
//
...
//    public static void uzunlugu8ile10ArasiOlanveyaOİleBiteniSil(List<String> list){
//
