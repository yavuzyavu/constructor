...
public class Fp04 {
    public static void main(String[] args) {
        //Fp04 obj= new Fp04 ();
        //System.out.println(obj.get7den100eToplam());(static yapmazsak bbu şekilde cagırırız)
        System.out.println("sirin : "+get7den100eToplam());
        System.out.println(get7den100eToplam1());
        System.out.println(get2den11eCarpim());
        System.out.println(faktoriyelHesapla(6));
        System.out.println(ikiSayiArasindakiCiftSayilarinToplami(7,5));
    ...
    public static int get7den100eToplam(){
       ...
       int x= IntStream.range(7,9).reduce(Math::addExact).getAsInt();
        return x;
    }
//2.Yol :
