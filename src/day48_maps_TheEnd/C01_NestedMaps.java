...
public class C01_NestedMaps {
    public static void main(String[] args) {
        /*
        eger bir elementle  ilgili tutacagimiz bilgiler coksa veya kompleks ise bu defa ici ice
        map kullanilmayi tercih ederiz
        ...
        orenek olarak dunki map'imizi maplarden olusan bir map olarak olusturalim
