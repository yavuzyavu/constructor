...
public class C03_Compute {
    public static void main(String[] args) {
        ...
        harfMapi.computeIfAbsent("C",(v)->(30));//varsa degistirmez
        harfMapi.computeIfAbsent("F",(v)->(30));
        harfMapi.computeIfPresent("E",(k,v)->(v+5));//varsa degistirir
        harfMapi.computeIfPresent("G",(k,v)->(v+5));//varsa! degistirir, yoksa degistirmez
